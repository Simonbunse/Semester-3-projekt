    ...
    return (
        <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-gray-300 h-full md:static md:w-auto transition-all rounded-lg"}>
            <nav className="flex flex-col gap-2">
                ...
                <Link href={'/live/'} className={pathname.includes('/live') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={pathname.includes('/live') ? activeIcon : inactiveIcon}>
                ...
                <Link href={'/prediction/'} className={pathname.includes('/prediction') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={pathname.includes('/prediction') ? activeIcon : inactiveIcon}>
